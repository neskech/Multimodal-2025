...
def test_clip_embeddings():
    ...
    try:
        ...
        print(
            f"✓ CLIP extractor initialized with dimension {extractor.get_embedding_dimension()}"
        )
...
def main():
    ...
    if passed == total:
        ...
        print(
            "   Note: CLIP and visualization tests may fail if dependencies are not installed."
        )
